...
local RayfieldFolder = "Silenthub"
...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			TabBackground = Color3.fromRGB(247, 180, 9),
			TabStroke = Color3.fromRGB(244, 175, 0),
			...
			SliderBackground = Color3.fromRGB(244, 175, 0),
			SliderProgress = Color3.fromRGB(244, 175, 0),
			SliderStroke = Color3.fromRGB(247, 180, 9),
